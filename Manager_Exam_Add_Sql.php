...
if(isset($_POST["add_exam"])){
					...
					$result = FALSE;
						...
						$type_img_Option5 = pathinfo(basename($_FILES['img_Option5']['name']), PATHINFO_EXTENSION);
						if($type_img_Option5 != null){
						$rand_name_img_Option5 = date("mdy").substr(md5(rand(0, 9999999)), 0, 100).".".$type_img_Option5;
						}else{
							$rand_name_img_Option5 = null;
						}
						$upload_path_img_Option5 = "upload/".$rand_name_img_Option5;
					    ...
					    $file_size6 =$_FILES['img_Option5']['size'];
						...
						if($file_size1 > 512000 || $file_size2 > 512000 || $file_size3 > 512000 || $file_size4 > 512000 || $file_size5 > 512000 || $file_size6 > 512000 ){
								...
								//header('Location: ' . $_SERVER['HTTP_REFERER']);
								  ...
								  move_uploaded_file($_FILES['img_Option5']['tmp_name'], $upload_path_img_Option5);

								  $sql = "INSERT INTO `manager_exam` (`id`, `proposition_exam`, `proposition_img_exam`, `answer1_exam`, `answer1_img_exam`, `answer2_exam`, `answer2_img_exam`, `answer3_exam`, `answer3_img_exam`, `answer4_exam`, `answer4_img_exam`,`answer5_exam`, `answer5_img_exam`, `result_exam`, `chapter_id_exam`)
...
if(isset($_POST["add_exam_annotated"])){
								$id_chapter = $_POST["id_chapter"];
								$proposition = $_POST["proposition"];
								$ans_annotated = $_POST["ans_annotated"];
								//echo $proposition."<br>";echo $Option1."<br>";echo $Option2."<br>";echo $Option3."<br>";echo $Option4."<br>";echo $img_proposition."<br>";echo $img_Option1."<br>";echo $img_Option2."<br>";echo $img_Option3."<br>";echo $img_Option4."<br>";echo $Option_true."<br>";
								$result = FALSE;
									...
									if($file_size1 > 512000){
											...
											//header('Location: ' . $_SERVER['HTTP_REFERER']);
											  ...
											  $sql = "INSERT INTO `manager_exam_annotated` (`id`, `proposition_exam`, `proposition_img_exam`, `ans_exam`, `chapter_id_exam`)
											  VALUES (NULL, '$proposition',
																			'$rand_name_img_type_img_proposition',
																			'$ans_annotated',
																			'$id_chapter');";
...
if(isset($_POST["edit_exam"])){
		  ...
		  if(isset($_POST["img_Option4"])){
			...
			if(isset($_POST["img_Option5"])){
			   $img_Option4 = $_POST["img_Option5"];
			   $exam_id = $_POST["exam_id"];
			   echo  $img_Option5;
			   $sql = "SELECT * FROM `manager_exam`WHERE `id` = $exam_id";
						$result = mysqli_query($conn, $sql);
						while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
							$answer5_img_exam = $row['answer4_img_exam'];
						}
						unlink( "upload/".$answer5_img_exam);

						$sql = "UPDATE `manager_exam` SET `answer5_img_exam` = ''
								 WHERE `manager_exam`.`id` = $exam_id;";
		  ...
		  //}
				...
				$sql = "SELECT * FROM `manager_exam`WHERE `id` = $exam_id";
						...
						$rand_name_img_Option5 = date("mdy").substr(md5(rand(0, 9999999)), 0, 100).".".$type_img_Option5;
							...
							$rand_name_img_Option5 = $answer5_img_exam;
						}
						$upload_path_img_Option5 = "upload/".$rand_name_img_Option5;
								  ...
								  `answer5_exam` = '$Option5',
								  `answer5_img_exam` = '$rand_name_img_Option5',
...
if(isset($_POST["edit_exam_annotated"])){
		  if(isset($_POST["img_proposition"])){
			   $img_proposition = $_POST["img_proposition"];
			   $exam_id = $_POST["exam_id"];
			   //echo  $img_proposition."<br>";
			   $sql = "SELECT * FROM `manager_exam_annotated`WHERE `id` = $exam_id";
						...
						$sql = "UPDATE `manager_exam_annotated` SET `proposition_img_exam` = ''
								 WHERE `manager_exam_annotated`.`id` = $exam_id;";
				...
				$sql = "SELECT * FROM `manager_exam_annotated`WHERE `id` = $exam_id";
						...
						$upload_path_img_proposition = "upload/".$rand_name_img_type_img_proposition;
								  ...
								  $sql = "UPDATE `manager_exam_annotated` SET
								  `proposition_exam` = '$proposition',
								  `proposition_img_exam` = '$rand_name_img_type_img_proposition',
								  `ans_exam` = '$ans_annotated',
								  `chapter_id_exam` = '$id_chapter'
								  WHERE `manager_exam_annotated`.`id` = $exam_id;";
