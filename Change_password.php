		...
		?>
          <div class="form-group">
              <h1><center>สำเร็จ</center></h1>
							<a href="testStd.php?id_std=<?php echo $id_std; ?>"><button class="btn btn-success btn-block">ตกลง</button></a>
          </div>

		<?php }else{ ?>
		<form action="manager_send_exam_mobile.php" method="POST">
          <div class="form-group">
		  ...
		  <div class="float-center">
				...
				<button style="float-center" type="submit" name="change_pass" class="btn btn-danger btn-block" onclick="goBack()">ยกเลิก</button>
			</div>
