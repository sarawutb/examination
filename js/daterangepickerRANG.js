...
(function (root, factory) {
  ...
  var DateRangePicker = function (element, options, cb) {
    ...
    if (this.element.is("input") && !this.singleDatePicker && this.autoUpdateInput) {
      let today = new Date(this.startDate.format());
      var startDateTh = today.toLocaleDateString("th-TH", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
        hour: "2-digit",
      ...
      let endtoday = new Date(this.endDate.format());
      var endDateTh = endtoday.toLocaleDateString("th-TH", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
        hour: "2-digit",
      ...
      this.element.val(startDateTh + this.locale.separator + endDateTh);
  ...
  DateRangePicker.prototype = {
    ...
    renderCalendar: function (side) {
      ...
      var dateHtml = this.locale.monthNames[calendar[1][1].month()] + " " + (year + 543);
    ...
    updateFormInputs: function () {
      ...
      if (this.container.find("input[name=daterangepicker_start]").is(":focus") || this.container.find("input[name=daterangepicker_end]").is(":focus")) return;
      {
        ...
        this.container.find("input[name=daterangepicker_start]").val(startDateTh);
      }
      if (this.endDate) {
        let endtoday = new Date(this.endDate.format());
        var endDateTh = endtoday.toLocaleDateString("th-TH", {
        ...
        this.container.find("input[name=daterangepicker_end]").val(endDateTh);
      }
    ...
    hoverDate: function (e) {
      ...
      let dateNow = new Date(this.date.format());
      var datefocus = dateNow.toLocaleDateString("th-TH", {
        year: "numeric",
        month: "2-digit",
        day: "2-digit",
        hour: "2-digit",
      ...
      if (this.endDate && !this.container.find("input[name=daterangepicker_start]").is(":focus")) {
        this.container.find("input[name=daterangepicker_start]").val(datefocus);
      } else if (!this.endDate && !this.container.find("input[name=daterangepicker_end]").is(":focus")) {
        this.container.find("input[name=daterangepicker_end]").val(datefocus);
      }
