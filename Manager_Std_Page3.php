	...
	<div class="container-fluid">
        ...
        <div class="card mb-3">
		  ...
		  <b><?php echo $branch_name; ?>
			...
			<?php
			$sql1 = "SELECT DISTINCT `degree_std`,`section_std` FROM `manager_std` WHERE branch_id_std = '$branch_id' AND IsUse = 1 AND (genre_std = 1 AND degree_std <=3 OR genre_std = 2 AND degree_std <=2) ORDER BY `manager_std`.`degree_std` ASC , `manager_std`.`section_std` + 0  ASC";
			...
			?>
				<a style="font-size:16px" class="ml-1" href="Manager_Std_List.php?genre_std=<?php echo $genre_std; ?>&branch_id=<?php echo $branch_id; ?>&degree_std=<?php echo $degree_std; ?>&section_std=<?php echo $section_std; ?>">ห้อง <?php echo $degree_std."/".$section_std; ?></a><br>
			<?php } ?>
