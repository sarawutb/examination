              ...
              if($data_teacher_gender == 1){
                ...
                $teacher_gender = "นางสาว";
                  ...
                  <tr>
                    ...
                    <td><?php echo $teacher_gender.$data_teacher_name; ?></td>
		...
		<form action="Manager_Teacher_Sql.php" method="POST">
          ...
          <div class="row">
            <div class="col-sm-2">
        			<div class="form-check">
        				<label class="form-check-label">
        					<input type="radio" class="form-check-input" name="gender_teacher" value="1" required="required"> นาย
        				</label>
        			</div>
              <div class="form-check">
        				<label class="form-check-label">
        					<input type="radio" class="form-check-input" name="gender_teacher" value="2" required="required"> นางสาว
        				</label>
        			</div>
              <div class="form-check">
        				<label class="form-check-label">
        					<input type="radio" class="form-check-input" name="gender_teacher" value="3" required="required"> นางสาว
        				</label>
        			</div>
            </div>
            </div>
            ...
            <div class="mt-2">
              ...
              <div class="col-sm-5">
                <div class="form-label-group">
                  <input type="text" class="form-control" name="last_teacher" required="required" autofocus="autofocus"></input>
                </div>
              </div>
          </div>
          </div>
