        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
                 ...
                 <th>
				 <a href="Manager_Std_Page2.php?genre_std=1">1.) ประกาศนียบัตรวิชาชีพ (ปวช.)</a><br>
				 <a href="Manager_Std_Page2.php?genre_std=2">2.) ประกาศนียบัตรวิชาชีพชั้นสูง (ปวส.)</a>
				 </th>
		  ...
		  <label for="inputEmail">คำนำหน้า</label>
			<div class="form-check">
				<label class="form-check-label">
					<input type="radio" class="form-check-input" name="gender_std" <?php if($data_teacher_status==1){echo "checked";}?> value="1" required="required"> นาย
				</label>
			</div>
			<div class="form-check">
				<label class="form-check-label">
					<input type="radio" class="form-check-input" name="gender_std" <?php if($data_teacher_status==2){echo "checked";}?> value="2" required="required"> นางสาว
				</label>
			</div>
          </div>
