        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
		   ...
		   <b><?php echo $branch_name; ?>
			...
			<?php
			$sql1 = "SELECT DISTINCT `degree_std`,`section_std` FROM `manage_std` WHERE branch_id_std = '$branch_id' AND genre_std = '$genre_std' AND IsUse = 1 ORDER BY `manage_std`.`degree_std` ASC";
