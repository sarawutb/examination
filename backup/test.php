...
<header class="static-top fixed-top" style="background-color: #E60000;margin-top:95px">
    <center style="padding-top:0px;"><font id="countDownTime" color="white" size="2px">เหลือเวลาทำข้อสอบ</font></center>
</header>
<form style="font-size:14px;margin-top: 115px;" id="frmSend" action="manager_send_exam_web.php" method="GET">
