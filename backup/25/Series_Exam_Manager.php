...
<form action="Series_Exam_Manager_Sql.php" method="POST">
      ...
      <div class="form-check">
        <input <?php if($manager=="edit" && $type_exam == 1){echo "checked";} ?> class="form-check-input" type="radio" name="type_exam" id="exampleRadios1" value="1" checked>
        <label class="form-check-label" for="exampleRadios1">
          สอบเก็บคะแนน
        </label>
      </div>
      <div class="form-check">
        <input <?php if($manager=="edit" && $type_exam == 2){echo "checked";} ?> class="form-check-input" type="radio" name="type_exam" id="exampleRadios2" value="2">
        <label class="form-check-label" for="exampleRadios2">
          สอบกลางภาค
        </label>
      </div>
      <div class="form-check">
        <input <?php if($manager=="edit" && $type_exam == 3){echo "checked";} ?> class="form-check-input" type="radio" name="type_exam" id="exampleRadios3" value="3">
    ...
    <label>เลือกข้อสอบ</label>
      <div style="border-radius: 5px 5px 5px 5px;" class="card-header">
        <input onclick="exam_type1()" <?php if($type_series_exam1==1){echo "checked";} ?> class="form-check-input ml-2" type="checkbox" name="type_series_exam1" id="ex_t1" value="1">
        ...
        <div id="point_1" class="form-inline mt-2">
    				...
    				<input required id="name_pointt1" style="margin-left:5px;width:100px" type="text" name="name_score_exam1[]" class="form-control" value="<?php if($manager=="edit"){echo $name_score_exam1;} ?>"   autofocus="autofocus" spellcheck="false" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required="required"></input>
            <label>&nbsp; คะแนน</label>
        </div>
        </div>
    ...
    <br>
    <div style="border-radius: 5px 5px 5px 5px;" class="card-header">
        <input onclick="exam_type2()" <?php if($type_series_exam2==2){echo "checked";} ?> class="form-check-input ml-2" type="checkbox" name="type_series_exam2" id="ex_t2" value="2">
