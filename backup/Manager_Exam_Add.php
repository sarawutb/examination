    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
		  ...
		  <li class="breadcrumb-item active"><b>บทที่ <?php echo $num_chapter ." ". $name_chapter; ?></b></li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class='far'>&#xf249;</i>
				บทที่  <?php echo $num_chapter ." ". $name_chapter; ?>
		  </div>
          <div class="card-body">
		  <div class="row">
		  <div class="col-sm-5">
		  ...
		  <label>ประเภทข้อสอบ</label>
			<div class="form-check">
				<label class="form-check-label">
					<input type="radio" checked onclick="myFunction1()" class="form-check-input" name="select" value="" checked> แบบปรนัย
				</label>
			</div>
			<div class="form-check">
				<label class="form-check-label">
					<input type="radio" onclick="myFunction2()" class="form-check-input" name="select" value=""> แบบอัตนัย
				</label>
			</div>
		</div>--->
		  ...
		  <h5>ตัวเลือกที่ 1</h5>
            <div class="form-label-group">
    			  <img hidden id="imgOption1" width="30%" height="30%"/>
              <textarea type="text" rows="4" name="Option1" id="Option1" class="form-control" required="required" autofocus="autofocus"><?php if(isset($_POST["add_exam"])){echo $Option1;} ?></textarea>
			  <font hidden id="imgOption1_size" hidden color='red'><b>*ขนาดรูปภาพใหญ่เกินไป</b></font>
			  <div class="form-inline">
			  <div class="input-group">
					<label>
						<span class="btn btn-warning">
							เลือกรูปภาพ  <input hidden type="file" name="img_Option1" id="img_Option1" class="form-control" autofocus="autofocus" accept="image/*" onchange="loadFile1(event)">
						</span>
					</label>
					<font color='black'><p>(ขนาดรูปไม่เกิน 512Kb)</p></font>
			  </div>
			  ...
			  <script>
				  var loadFile1 = function(event) {
					document.getElementById("imgOption1").hidden = false;
					var reader = new FileReader();
					reader.onload = function(){
					  var imgOption1 = document.getElementById('imgOption1');
					  imgOption1.src = reader.result;
					};
					reader.readAsDataURL(event.target.files[0]);
				  };
				</script>
		  ...
		  <h5>ตัวเลือกที่ 2</h5>
            <div class="form-label-group">
              <img hidden id="imgOption2" width="30%" height="30%"/>
              <textarea type="text" rows="4" name="Option2" id="Option2" class="form-control" required="required" autofocus="autofocus"><?php if(isset($_POST["add_exam"])){echo $Option2;} ?></textarea>
			  <font id="imgOption2_size" hidden color='red'><b>*ขนาดรูปภาพใหญ่เกินไป</b></font>
			  <div class="form-inline">
			  <div class="input-group">
					<label>
						<span class="btn btn-warning">
							เลือกรูปภาพ  <input hidden type="file" name="img_Option2" id="img_Option2" class="form-control" autofocus="autofocus" accept="image/*" onchange="loadFile2(event)">
						</span>
					</label>
					<font color='black'><p>(ขนาดรูปไม่เกิน 512Kb)</p></font>
			  </div>
			  ...
			  <script>
				  var loadFile2 = function(event) {
					document.getElementById("imgOption2").hidden = false;
					var reader = new FileReader();
					reader.onload = function(){
					  var imgOption2 = document.getElementById('imgOption2');
					  imgOption2.src = reader.result;
					};
					reader.readAsDataURL(event.target.files[0]);
				  };
				</script>
		  ...
		  <h5>ตัวเลือกที่ 3</h5>
            <div class="form-label-group">
                  <img hidden id="imgOption3" width="30%" height="30%"/>
              <textarea type="text" rows="4" name="Option3" id="Option3" class="form-control" required="required" autofocus="autofocus"><?php if(isset($_POST["add_exam"])){echo $Option3;} ?></textarea>
			  <font id="imgOption3_size" hidden color='red'><b>*ขนาดรูปภาพใหญ่เกินไป</b></font>
			  <div class="form-inline">
				  <div class="input-group">
						<label>
							<span class="btn btn-warning">
								เลือกรูปภาพ  <input hidden type="file" name="img_Option3" id="img_Option3" class="form-control" autofocus="autofocus" accept="image/*" onchange="loadFile3(event)">
							</span>
						</label>
						<font color='black'><p>(ขนาดรูปไม่เกิน 512Kb)</p></font>
				  </div>
			  ...
			  <script>
				  var loadFile3 = function(event) {
					document.getElementById("imgOption3").hidden = false;
					var reader = new FileReader();
					reader.onload = function(){
					  var imgOption3 = document.getElementById('imgOption3');
					  imgOption3.src = reader.result;
					};
					reader.readAsDataURL(event.target.files[0]);
				  };
				</script>
		  ...
		  <h5>ตัวเลือกที่ 4</h5>
            <div class="form-label-group">
    				   <img hidden id="imgOption4" width="30%" height="30%"/>
              <textarea type="text" rows="4" name="Option4" id="Option4" class="form-control" required="required" autofocus="autofocus"><?php if(isset($_POST["add_exam"])){echo $Option4;} ?></textarea>

			  <font id="imgOption4_size" hidden color='red'><p>*ขนาดรูปภาพใหญ่เกินไป</p></font>
				<div class="form-inline">
					<div class="input-group">
					<label>
						<span class="btn btn-warning">
							เลือกรูปภาพ  <input hidden type="file" name="img_Option4" id="img_Option4" class="form-control" autofocus="autofocus" accept="image/*" onchange="loadFile4(event)">
						</span>
					</label>
					<font color='black'><p>(ขนาดรูปไม่เกิน 512Kb)</p></font>
					</div>
			  ...
			  <script>
				  var loadFile4 = function(event) {
					document.getElementById("imgOption4").hidden = false;
					var reader = new FileReader();
					reader.onload = function(){
					  var imgOption4 = document.getElementById('imgOption4');
					  imgOption4.src = reader.result;
					};
					reader.readAsDataURL(event.target.files[0]);
				  };
				</script>
		  ...
		  <h5>คำตอบที่ถูกต้อง</h5>
			...
			<select name="Option_true" class="form-control" id="Option_true" required="required">
			  ...
			  <option <?php if(isset($_POST["add_exam"])){if($Option_true == 1){echo "selected";}} ?> value="1">ตัวเลือกที่ 1</option>
			  <option <?php if(isset($_POST["add_exam"])){if($Option_true == 2){echo "selected";}} ?> value="2">ตัวเลือกที่ 2</option>
			  <option <?php if(isset($_POST["add_exam"])){if($Option_true == 3){echo "selected";}} ?> value="3">ตัวเลือกที่ 3</option>
			  <option <?php if(isset($_POST["add_exam"])){if($Option_true == 4){echo "selected";}} ?> value="4">ตัวเลือกที่ 4</option>
			</select>
          ...
          <button type="submit" name="add_exam" class="btn btn-success btn-block">บันทึกข้อสอบ</button>
		...
		<div class="card mb-3">
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody>
				  ...
				  <div class="panel-heading">
					...
					<input type="submit" name="delete_all_exam" value="ลบที่เลือก" class="btn btn-danger"></input>
					<hr>
					</h4>
				  </div>
				  </div>
		  ...
		  <div class="panel-group">
				<div class="panel panel-default">
				  <div class="panel-heading">
					<h4 class="panel-title">
							<a style="font-size:80%" id="userDropdown" href="#collapse<?php echo $num_chapter;?>" role="button" data-toggle="collapse">
				  ...
				  <div id="collapse<?php echo $num_chapter;?>" class="panel-collapse collapse">
					<div class="card-body">
							...
							<div class="form-label-group">
							  ...
							  <div class="image-area">
								<input hidden id="imgProposition_remove<?php echo $num_chapter;?>" type="text" value="p">
								  <center><img id="imgProposition_sql<?php echo $num_chapter;?>" <?php if($proposition_img_exam==null){echo "hidden";} ?> src="upload/<?php echo $proposition_img_exam;?>" style="max-width: auto;height: 350px;"></center>
							  ...
							  <textarea type="text" rows="8" class="form-control"  name="proposition" required="required" autofocus="autofocus"><?php echo $proposition_exam; ?></textarea>
									<div class="input-group">
									  <label>
										<span class="btn btn-warning">
						  ...
						  <h5>ตัวเลือกที่ 1</h5>
							...
							<div class="image-area">
								<input hidden id="Option1_remove<?php echo $num_chapter;?>" type="text" value="1">
								<img id="imgOption1sql<?php echo $num_chapter;?>" <?php if($answer1_img_exam==null){echo "hidden";} ?> src="upload/<?php echo $answer1_img_exam;?>" width="30%" height="30%">
								<textarea type="text" rows="4" name="Option1" id="Option1" class="form-control" required="required" autofocus="autofocus"><?php echo $answer1_exam; ?></textarea>
								<a id="btn_Option1_remove<?php echo $num_chapter;?>" onClick="Option1_remove<?php echo $num_chapter;?>()" <?php if($answer1_img_exam==null){echo "hidden";} ?> ><button class="remove-image"  style="display: inline;" type="button">&#215;</button></a>
							</div>
								<div class="input-group">
									<label>
										<span class="btn btn-warning">
										  เลือกรูปภาพ  <input onClick="Option1_remove_file<?php echo $num_chapter; ?>()" hidden type="file" name="img_Option1" id="img_Option1<?php echo $num_chapter;?>" class="form-control" autofocus="autofocus" accept="image/*" value="<?php echo $answer1_img_exam; ?>" onchange="loadFile1_sql<?php echo $num_chapter;?>(event)">
										</span>
									</label>
									<font color='black'><p>(ขนาดรูปไม่เกิน 512Kb)</p></font>
								</div>
							  <script>
								  var loadFile1_sql<?php echo $num_chapter;?> = function(event) {
									document.getElementById("imgOption1sql<?php echo $num_chapter;?>").hidden = false;
									var reader = new FileReader();
									reader.onload = function(){
									  var imgOption1sql = document.getElementById('imgOption1sql<?php echo $num_chapter;?>');
									  imgOption1sql.src = reader.result;
									};
									reader.readAsDataURL(event.target.files[0]);
								  };
									function Option1_remove<?php echo $num_chapter; ?>(){
										document.getElementById("imgOption1sql<?php echo $num_chapter; ?>").hidden = true;
										document.getElementById("btn_Option1_remove<?php echo $num_chapter; ?>").hidden = true;
										document.getElementById("Option1_remove<?php echo $num_chapter; ?>").setAttribute("name", "img_Option1");
										document.getElementById("img_Option1<?php echo $num_chapter; ?>").setAttribute("name", "");
									}
									function Option1_remove_file<?php echo $num_chapter; ?>(){
										document.getElementById("btn_Option1_remove<?php echo $num_chapter; ?>").hidden = false;
										document.getElementById("Option1_remove<?php echo $num_chapter; ?>").setAttribute("name", "");
										document.getElementById("img_Option1<?php echo $num_chapter; ?>").setAttribute("name", "img_Option1");
									}
								</script>
							</div>
						  </div>
						  ...
						  <h5>ตัวเลือกที่ 2</h5>
							...
							<div class="image-area">
							  ...
							  <img id="imgOption2sql<?php echo $num_chapter;?>" <?php if($answer2_img_exam==null){echo "hidden";} ?> src="upload/<?php echo $answer2_img_exam;?>" width="30%" height="30%">
							  ...
							  <a id="btn_Option2_remove<?php echo $num_chapter;?>" onClick="Option2_remove<?php echo $num_chapter;?>()" <?php if($answer2_img_exam==null){echo "hidden";} ?>><button class="remove-image"  style="display: inline;" type="button">&#215;</button></a>
							</div>
							  <div class="input-group">
									<label>
										<span class="btn btn-warning">
						  ...
						  <h5>ตัวเลือกที่ 3</h5>
							<div class="form-label-group">
							  ...
							  <img id="imgOption3sql<?php echo $num_chapter;?>" <?php if($answer3_img_exam==null){echo "hidden";} ?> src="upload/<?php echo $answer3_img_exam;?>" width="30%" height="30%">
							  <a id="btn_Option3_remove<?php echo $num_chapter;?>" onClick="Option3_remove<?php echo $num_chapter;?>()" <?php if($answer3_img_exam==null){echo "hidden";} ?>><button class="remove-image"  style="display: inline;" type="button">&#215;</button></a>
						  ...
						  <h5>ตัวเลือกที่ 4</h5>
							<div class="form-label-group">
							  ...
							  <img id="imgOption4sql<?php echo $num_chapter;?>" <?php if($answer4_img_exam==null){echo "hidden";} ?> src="upload/<?php echo $answer4_img_exam;?>" width="30%" height="30%">
							  <a id="btn_Option4_remove<?php echo $num_chapter;?>" onClick="Option4_remove<?php echo $num_chapter;?>()" <?php if($answer4_img_exam==null){echo "hidden";} ?>><button class="remove-image"  style="display: inline;" type="button">&#215;</button></a>
						  ...
						  <h5>คำตอบที่ถูกต้อง</h5>
							...
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" <?php if($result_exam == 1){ echo "checked";} ?> class="form-check-input" name="Option_true" value="1"> ตัวเลือกที่ 1
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" <?php if($result_exam == 2){ echo "checked";} ?> class="form-check-input" name="Option_true" value="2"> ตัวเลือกที่ 2
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" <?php if($result_exam == 3){ echo "checked";} ?> class="form-check-input" name="Option_true" value="3"> ตัวเลือกที่ 3
								</label>
							</div>
							<div class="form-check">
								<label class="form-check-label">
									<input type="radio" <?php if($result_exam == 4){ echo "checked";} ?> class="form-check-input" name="Option_true" value="4"> ตัวเลือกที่ 4
								</label>
							</div>
						 ...
						 <hr>
						  <button type="submit" name="edit_exam" class="btn btn-primary btn-block">อัพเดทข้อสอบ</button>
						</form>
					...
					<td>
					<a href="Manager_Exam_Add_Sql.php?id_chapter=<?php echo $id_chapter;?>&id_exam=<?php echo $exam_id;?>&delete_exam" onclick="return buttonDelete<?php echo $num_chapter; ?>();"><button type="button" class="btn btn-danger"><b>ลบ<b></button></a>
					</td>
                  </tr>
				  <?php $num_chapter++; } ?>
				 </tbody>
...
function check_uncheck_all(){
 ...
 if(checkedVal.checked==true){
		document.getElementById("input_Check_num<?php echo $i; ?>").checked = true;
 }else{
		document.getElementById("input_Check_num<?php echo $i; ?>").checked = false;
