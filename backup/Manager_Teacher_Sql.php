...
if(isset($_POST["add_teacher"])){
					...
					$sql = "INSERT INTO `manager_teacher` (`id_teacher`, `name_teacher`, `email_teacher`, `password_teacher`, `status_teacher`) 
					VALUES (NULL, '$name_teacher', '$email_teacher', '$password_teacher', '$status_teacher');";
