...
<input hidden type="text" name="send_exam" value="send_exam"/>
	...
	while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){
		...
		​<?php
		// $a=array(143,144,145,146,147,148,149,150,151,152);
		// shuffle($a);
		//
		// print_r($a);
		$arr_list_series_exam = explode(',',$row['list_series_exam']);
							  ...
							  <?php echo "ข้อที่ ".$i; ?>). <?php echo $proposition_exam; ?>
									...
									<div class="radio-toolbar" >
											<div class="card-body" >
												  ...
												  <input id="radio<?php echo $ans_type_subjects; ?><?php echo $i; ?>" required type="radio" name="Ans[<?php echo $i; ?>]" value="<?php echo $ans_type_subjects; ?>">
