...
$pdf->Write ( 5, iconv ( 'UTF-8', 'cp874', ' www.select2web.com' ) );
$pdf->Ln ();
$pdf->Write ( 5, iconv ( 'UTF-8', 'cp874', 'เว็พที่เราชอบเข้าคือ Mthai' ), 'www.mthai.com' );
// รูปแบบคำสั่ง
// Write($h, $txt, $link='')
// write = เป็นคำสั่ง พิมพ์ข้อความ ลงใน File PDF มีความสามารถมากกว่า Text Write สามารถ ขึ้นบรรทัดใหม่ได้ และสามารถที่จะ พิมพ์ Url ได้
