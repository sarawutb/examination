...
<form style="font-size:14px;margin-top: 90px;padding-bottom:55px" id="frmSend" action="manager_send_exam_std.php" method="POST">
					...
					<div style="font-size:17px;">
							  ...
							  <?php echo "ข้อที่ ".$i; ?>). <?php echo $proposition_exam; ?>
									...
									<div class="radio-toolbar" >
											<div class="card-body" >
												  <?php $num_ans=1; foreach($ans_type_subject as $ans_type_subjects){?>
